...
const xImage=useTransform(scrollYProgress,[0,1],['0%','80%'])
    ...
    return ( 
    <div className="w-full overflow-hidden text-center h-full flex flex-col lg:flex-row md:p-10  p-3  gap-1  ">
            ...
            <motion.div style={{y:xImage}} className="w-full h-1/2 lg:w-1/2 lg:h-full  relative">
